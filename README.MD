...
- [Authenticating pipelines using git secret](https://docs.redhat.com/en/documentation/red_hat_openshift_pipelines/1.10/html/securing_openshift_pipelines/authenticating-pipelines-using-git-secret)
